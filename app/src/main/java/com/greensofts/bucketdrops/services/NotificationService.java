package com.greensofts.bucketdrops.services;

import android.app.IntentService;
import android.app.Notification;
import android.content.Intent;

import com.greensofts.bucketdrops.ActivityMain;
...
public class NotificationService extends IntentService {
    ...
    private boolean isNotificationNeeded(long added, long when) {
        ...
        if (now > when) {
            ...
            long diffrence90 = (long) (0.9 * (when - added));
            return (now > (added + diffrence90)) ? true : false;
        }
    }
}
